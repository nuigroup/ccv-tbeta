...
void ofxTuioClient::addTuioBlob(TuioBlob *tblb){
	ofNotifyEvent(blobAdded, *tblb, this);
...
void ofxTuioClient::removeTuioBlob(TuioBlob *tblb){
	ofNotifyEvent(blobRemoved, *tblb, this);
	
	if (bVerbose) 
		std::cout << "del blb " << tblb->getBlobID() << " (" <<  tblb->getSessionID() << ") " << tblb->getX() << " " << tblb->getY() << std::endl;
	
}

void ofxTuioClient::updateTuioBlob(TuioBlob *tblb){
	ofNotifyEvent(blobUpdated, *tblb, this);
	
	if (bVerbose) 
		std::cout << "set blb " << tblb->getBlobID() << " (" <<  tblb->getSessionID() << ") " << tblb->getX() << " " << tblb->getY() << std::endl;
