...
public:
	...
	//events from the Client. POCO seems to  know only one parameter so i made another Method where the x,y values are sent
	void addCursorPOCO(TuioCursor & _tcur);
